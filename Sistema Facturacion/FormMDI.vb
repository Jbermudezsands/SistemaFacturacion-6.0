...
Public Class FormMDI
    ...
    Private Sub ExitButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles RbbonSalir.Click, RibbonMenu1.DoubleClick
        Close()
    End Sub
    ...
    Private Sub ViewZoomCombobox_ChangeCommitted(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub NormalSizeButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        SetZoomFactor(1)
    End Sub
    ...
    Private Sub c1Ribbon1_RibbonEvent(ByVal sender As System.Object, ByVal e As C1.Win.C1Ribbon.RibbonEventArgs) Handles c1Ribbon1.RibbonEvent
        Select Case e.EventType
            Case C1.Win.C1Ribbon.RibbonEventType.ChangeCanceled, _
                C1.Win.C1Ribbon.RibbonEventType.ChangeCommitted, _
                C1.Win.C1Ribbon.RibbonEventType.Click, _
                C1.Win.C1Ribbon.RibbonEventType.DialogLauncherClick, _
    ...
    Private Function PromptToSaveDocument() As Boolean
        ...
        dr = MessageBox.Show("Do you want to save '" + documentName + "'?", _
    ...
    Private Function SaveDocument(ByVal showDialog As Boolean) As Boolean
        If showDialog Then
            ...
            dlg.Filter = "Rich text file (*.rtf)|*.rtf|" + _
                    "Rich text file, no OLE objects (*.rtf)|*.rtf|" + _
    ...
    Private Sub InitializeRecentDocumentList()
        ...
        recentDocuments = New RecentDocumentList(c1Ribbon1.ApplicationMenu.RightPaneItems, _
    ...
    Private Class RecentDocumentList
        ...
        Public Sub New(ByVal rightPaneItems As RibbonItemCollection, ByVal files As StringCollection, ByVal loadDocument As LoadDocumentDelegate)
            ...
            Dim listItem As RibbonListItem = New RibbonListItem(New RibbonLabel("Recordatorios"))
