Public Class FrmEnfermeras
    ...
    Public Sub Limpiar_Doctores(ByVal LimpiarCodigo As Boolean)
        ...
        Me.Telefono.Text = ""
        Me.Correo.Text = ""
        Me.Especialidad.Text = ""
        Me.ChkActivo.Checked = False

    End Sub

    Private Sub CmdGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdGuardar.Click
        Grabar_Doctores(Me.TxtCodigoMinsa.Text, Nombres.Text, Apellidos.Text, Telefono.Text, Correo.Text, Me.Especialidad.Text, Me.TxtDireccion.Text, "Enfermera", Me.ChkActivo.Checked)
    ...
    Private Sub TxtCodigoMinsa_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtCodigoMinsa.TextChanged
        ...
        If Me.TxtCodigoMinsa.Text <> "" Then
            SqlString = "SELECT dbo.Doctores.* FROM dbo.Doctores WHERE (Codigo_Minsa = '" & Me.TxtCodigoMinsa.Text & "') AND (Tipo = 'Enfermera')"
            ...
            If Not DataSet.Tables("Doctores").Rows.Count = 0 Then
                ...
                If Not IsDBNull(DataSet.Tables("Doctores").Rows(0)("Especialidad_Doctor")) Then
                    Me.Especialidad.Text = DataSet.Tables("Doctores").Rows(0)("Especialidad_Doctor")
                End If
    ...
    Private Sub FrmEnfermeras_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim SqlString As String
        Dim DataSet As New DataSet, DataAdapter As New SqlClient.SqlDataAdapter

        SqlString = "SELECT DISTINCT Especialidad_Doctor  FROM Doctores"
        DataAdapter = New SqlClient.SqlDataAdapter(SqlString, MiConexion)
        DataAdapter.Fill(DataSet, "Enfermeras")

        Me.Especialidad.DataSource = DataSet.Tables("Enfermeras")
    End Sub
End Class