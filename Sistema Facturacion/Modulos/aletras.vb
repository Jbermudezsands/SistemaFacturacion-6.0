Module aletras
    ...
    Public Function Letras(ByVal numero As String, ByVal Moneda As String) As String
        ...
        Dim palabras As String = "", entero As String = "", dec As String = "", flag As String
        ...
        For x = 1 To numero.ToString.Length
            If Mid(numero, 1, 1) = "0" Then
                ...
                If Trim(numero.ToString.Length) = 0 Then palabras = "Cero"
            Else
                Exit For
            End If
        Next
        ...
        If Val(numero) <= 999999999 Then
            ...
            If dec <> "" Then
                Letras = palabras & " " & Moneda & " con " & dec & " Centavos"
            Else
                Letras = palabras & " " & Moneda
            End If
        Else
            Letras = ""
        End If
