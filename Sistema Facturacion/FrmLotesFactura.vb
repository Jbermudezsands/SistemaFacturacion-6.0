...
Existencias AS (
    ...
    SELECT
        ...
        CASE 
            WHEN M.Lote = 'SINLOTE' THEN NULL
            ELSE L.FechaVence
        END AS Fecha_Vencimiento,

        CASE 
            WHEN M.Lote = 'SINLOTE' THEN 1
            ELSE L.Activo
        END AS Activo,

        SUM(M.CantidadMovimiento) AS Existencia

    FROM Movimientos M

    LEFT JOIN Lote L
        ON M.Lote <> 'SINLOTE'
        AND REPLACE(UPPER(L.Numero_Lote),' ','') = M.Lote
...
-- =====================================
-- CALCULO EXISTENCIA TOTAL BODEGA
-- =====================================
...
SELECT
    ...
    CASE 
        WHEN ExistenciaTotal <= 0 THEN 0
        WHEN Existencia > ExistenciaTotal THEN ExistenciaTotal
        ELSE Existencia
    END AS Existencia
...
ORDER BY
    ...
    Existencia DESC;"
        ...
        DataAdapter.SelectCommand.Parameters.AddWithValue("@FechaCorte", FechaVence)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        NLotes = Me.C1TrueDBGrid1.Columns("NumeroLote").Text
        If Me.C1TrueDBGrid1.Columns("FechaVence").Text <> "" Then
