Public Class FrmRecepcionPlanilla
    Public MiConexion As New SqlClient.SqlConnection(Conexion), CodigoIva As String, CantidadAnterior As Double, PrecioAnterior As Double, TipoProductor As String
    Private Sub TrueDBGridComponentes_AfterUpdate(ByVal sender As Object, ByVal e As System.EventArgs) Handles TrueDBGridComponentes.AfterUpdate
        ...
        Else
            ...
            SqlProveedor = "SELECT Productor.* FROM Productor WHERE (CodProductor = '" & Me.TxtCodigoProveedor.Text & "') AND (TipoProductor = 'Productor')"
        ...
        ActualizaMETODORecepcionPlanilla()

        '////////////////////////////////////////////////////////////////////////////////////////////////////
        '/////////////////////////////GRABO EL ENCABEZADO DE LA COMPRA /////////////////////////////////////////////
        '//////////////////////////////////////////////////////////////////////////////////////////////////////////7
        GrabaComprasRecepcion(NumeroCompra)
        ...
        End If
        If Not IsDBNull(PrecioNeto = Me.BindingDetalle.Item(iPosicion)("Precio_Neto")) Then
        ...
        GrabaDetalleRecepcionPlanilla(NumeroCompra, CodigoProducto, PrecioUnitario, Descuento, PrecioNeto, Importe, Cantidad)
    ...
    Private Sub TrueDBGridComponentes_BeforeColUpdate(ByVal sender As Object, ByVal e As C1.Win.C1TrueDBGrid.BeforeColUpdateEventArgs) Handles TrueDBGridComponentes.BeforeColUpdate
        ...
        Else
            ...
            SqlProveedor = "SELECT  * FROM Productor  WHERE (CodProductor = '" & Me.TxtCodigoProveedor.Text & "')"
            DataAdapter = New SqlClient.SqlDataAdapter(SqlProveedor, MiConexion)
            DataAdapter.Fill(DataSet, "Productor")
            If DataSet.Tables("Productor").Rows.Count = 0 Then
    ...
    Private Sub FrmRecepcionPlanilla_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub TxtCodigoProveedor_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtCodigoProveedor.TextChanged
        Try
            ...
            SqlProveedor = "SELECT  * FROM Productor  WHERE (CodProductor = '" & Me.TxtCodigoProveedor.Text & "') AND (TipoProductor = 'Productor')"
            DataAdapter = New SqlClient.SqlDataAdapter(SqlProveedor, MiConexion)
            DataAdapter.Fill(DataSet, "Productor")
            If Not DataSet.Tables("Productor").Rows.Count = 0 Then
                Me.TxtNombres.Text = DataSet.Tables("Productor").Rows(0)("NombreProductor")
    ...
    Private Sub ButtonAgregar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonAgregar.Click
        ...
        Do While iPosicion < Registros
            ...
            GrabaMetodoDetalleRecepcion(NumeroCompra, NombrePago, Monto, NumeroTarjeta, FechaVenceTarjeta)
            iPosicion = iPosicion + 1
        Loop
    ...
    Private Sub ButtonBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonBorrar.Click
        ...
        '/////////////////////////////////////////////////////////////////////////////////////////////////
        SqlCompras = "UPDATE [Compras]  SET [Activo] = 'False',[Nombre_Proveedor] = '******CANCELADO',[Apellido_Proveedor] = '******' " & _
    ...
    Private Sub CmdFacturar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdFacturar.Click
        ...
        '/////////////////////////////GRABO EL ENCABEZADO DE LA COMPRA /////////////////////////////////////////////
        '//////////////////////////////////////////////////////////////////////////////////////////////////////////7
        GrabaEncabezadoCompras(NumeroCompra, Me.DTPFecha.Value, "Mercancia Recibida", Me.TxtCodigoProveedor.Text, Me.CboCodigoBodega.Text, Me.TxtNombres.Text, Me.TxtApellidos.Text, Me.DTPFecha.Value, Val(Me.TxtSubTotal.Text), Val(Me.TxtIva.Text), Val(Me.TxtPagado.Text), Val(Me.TxtNetoPagar.Text), Me.TxtMonedaFactura.Text, "Procesado por la Orden de Compra " & Me.TxtNumeroEnsamble.Text, "", False)
