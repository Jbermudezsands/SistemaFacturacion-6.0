...
Partial Public Class ArepGraficoVentasClientes 
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ArepGraficoVentasClientes))
        ...
        Me.ChartControl1 = New DataDynamics.ActiveReports.ChartControl
        ...
        'PageHeader1
        '
        Me.PageHeader1.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.LblTitulo, Me.LblDireccion, Me.LblRuc, Me.Label1, Me.Label9, Me.TextBox14, Me.LblRango, Me.Label4, Me.lblQty, Me.lblProductID, Me.Label5, Me.LblMoneda, Me.ChartControl1})
        Me.PageHeader1.Height = 6.989583!
        ...
        Me.Label1.Text = "Reporte Clientes"
        Me.Label1.Top = 0.625!
        ...
        Me.TextBox1.DataField = "Cod_Cliente"
        Me.TextBox1.Height = 0.2105263!
        Me.TextBox1.Left = 1.473684!
        ...
        Me.TextBox2.DataField = "Nombre_Cliente"
        Me.TextBox2.DistinctField = "Nombre_Cliente"
        Me.TextBox2.Height = 0.2105263!
        Me.TextBox2.Left = 2.210526!
        ...
        Me.LblPorciento.Height = 0.2105263!
        Me.LblPorciento.HyperLink = Nothing
        Me.LblPorciento.Left = 6.157895!
        ...
        Me.LblPorciento.Width = 0.5263155!
        '
        'PageFooter1
        '
        ...
        Me.ChartControl1.Backdrop = New DataDynamics.ActiveReports.Chart.BackdropItem(DataDynamics.ActiveReports.Chart.Graphics.GradientType.Vertical, System.Drawing.Color.White, System.Drawing.Color.SteelBlue)
        Me.ChartControl1.Border.BottomColor = System.Drawing.Color.Black
        Me.ChartControl1.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.ChartControl1.Border.LeftColor = System.Drawing.Color.Black
        Me.ChartControl1.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.ChartControl1.Border.RightColor = System.Drawing.Color.Black
        Me.ChartControl1.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.ChartControl1.Border.TopColor = System.Drawing.Color.Black
        Me.ChartControl1.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        ...
        Axis1.MajorTick = New DataDynamics.ActiveReports.Chart.Tick(New DataDynamics.ActiveReports.Chart.Graphics.Line, New DataDynamics.ActiveReports.Chart.Graphics.Line(System.Drawing.Color.Transparent, 0, DataDynamics.ActiveReports.Chart.Graphics.LineStyle.None), 1, 0.0!, False)
        ...
        ChartArea1.Projection = New DataDynamics.ActiveReports.Chart.Projection(DataDynamics.ActiveReports.Chart.Graphics.ProjectionType.Orthogonal, 0.1!, 0.1!)
        ChartArea1.WallYZ = New DataDynamics.ActiveReports.Chart.PlaneItem(New DataDynamics.ActiveReports.Chart.Graphics.Backdrop, 1.0!)
        Me.ChartControl1.ChartAreas.AddRange(New DataDynamics.ActiveReports.Chart.ChartArea() {ChartArea1})
        Me.ChartControl1.ChartBorder = New DataDynamics.ActiveReports.Chart.Border(New DataDynamics.ActiveReports.Chart.Graphics.Line(System.Drawing.Color.Transparent, 0, DataDynamics.ActiveReports.Chart.Graphics.LineStyle.None), 0, System.Drawing.Color.Black)
        OleDBDataSource1.ConnectionString = "Provider=SQLOLEDB;Password=P@ssword;Persist Security Info=True;User ID=sa;Initial" & _
            " Catalog=SistemaFacturacionDISTELSA;Data Source=JUAN\SQL2005"
        OleDBDataSource1.SQL = resources.GetString("OleDBDataSource1.SQL")
        Me.ChartControl1.DataSource = OleDBDataSource1
        Me.ChartControl1.Height = 5.052631!
        Me.ChartControl1.Left = 0.1052632!
        ...
        Me.ChartControl1.Legends.AddRange(New DataDynamics.ActiveReports.Chart.Legend() {Legend1})
        ...
        Me.ChartControl1.Titles.AddRange(New DataDynamics.ActiveReports.Chart.Title() {Title3, Title4})
        Me.ChartControl1.Top = 1.421053!
        Me.ChartControl1.UIOptions = DataDynamics.ActiveReports.Chart.UIOptions.ForceHitTesting
        Me.ChartControl1.Width = 7.789473!
        '
        'GroupHeader1
        '
        Me.GroupHeader1.Height = 0.03125!
        ...
        Me.Label2.Left = 6.157895!
        Me.Label2.Name = "Label2"
        Me.Label2.Style = "ddo-char-set: 0; text-align: right; font-size: 8.25pt; "
        Me.Label2.Text = "%"
        Me.Label2.Top = 0.0!
        Me.Label2.Width = 0.5263155!
        '
        'ArepGraficoVentasClientes
        '
    ...
    Friend WithEvents ChartControl1 As DataDynamics.ActiveReports.ChartControl
