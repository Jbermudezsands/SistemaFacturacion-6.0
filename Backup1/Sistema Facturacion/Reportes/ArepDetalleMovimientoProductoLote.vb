...
Public Class ArepDetalleMovimientoProductoLote 
    ...
    Private Sub GroupHeader1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupHeader1.Format
        ...
        If FrmReportes.CmbAgrupado.Text = "Bodega" Then
            Inicial = BuscaInventarioInicialEntreBodegaLote(Me.TxtCodProducto.Text, FechaIni, My.Forms.FrmReportes.CmbRango1.Text, My.Forms.FrmReportes.CmbRango2.Text, FrmReportes.CboLoteIni.Text, FrmReportes.CboLoteFin.Text)
        Else
