Public Class FrmCuentasXPagar
    ...
    Private Sub CmdGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdGrabar.Click
        ...
        Do While Registros > i
            ...
            SQlString = "SELECT * FROM  ReciboPago INNER JOIN DetalleReciboPago ON ReciboPago.CodReciboPago = DetalleReciboPago.CodReciboPago AND ReciboPago.Fecha_Recibo = DetalleReciboPago.Fecha_Recibo WHERE (ReciboPago.Cod_Proveedor = '" & Me.CboCodigoProveedor.Text & "') AND (DetalleReciboPago.Numero_Compra = '" & Numero_Compra & "') "
            DataAdapter = New SqlClient.SqlDataAdapter(SQlString, MiConexion)
