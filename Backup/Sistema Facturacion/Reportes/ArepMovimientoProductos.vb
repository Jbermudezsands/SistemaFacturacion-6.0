...
Public Class ArepMovimientoProductos
    ...
    Private Sub GroupFooter1_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupFooter1.Format
        ...
        '                "WHERE (Detalle_Compras.Cod_Producto = '" & CodProductos & "') AND (Compras.Cod_Bodega BETWEEN '" & CodBodega1 & "' AND '" & CodBodega2 & "') AND (Detalle_Compras.Tipo_Compra <> 'Devolucion de Compra') AND (Compras.Fecha_Compra BETWEEN CONVERT(DATETIME, '" & FechaIni & "', 102) AND CONVERT(DATETIME, '" & FechaFin & "', 102))"
        'End If
